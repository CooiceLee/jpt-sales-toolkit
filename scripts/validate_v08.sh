...
"$PYTHON_BIN" test_queue_completeness_and_money.py
"$PYTHON_BIN" test_queue_money_frontend_contract.py
"$PYTHON_BIN" test_count_refresh_reports_failure.py
"$PYTHON_BIN" test_manual_entry_first_record.py
"$PYTHON_BIN" test_manual_entry_frontend_contract.py
"$PYTHON_BIN" test_business_actions_create.py
"$PYTHON_BIN" test_translation_boundary.py
"$PYTHON_BIN" test_business_text_is_text.py
"$PYTHON_BIN" test_trip_page_order.py
"$PYTHON_BIN" test_trip_zones_frontend_contract.py
"$PYTHON_BIN" test_trip_route_bar_contract.py
"$PYTHON_BIN" test_trip_editor_lifecycle_contract.py
"$PYTHON_BIN" test_trip_team_endpoints_contract.py
"$PYTHON_BIN" test_trip_team_map_contract.py
"$PYTHON_BIN" test_trip_team_itinerary_contract.py
"$PYTHON_BIN" test_trip_team_visit_drop_contract.py
"$PYTHON_BIN" test_trip_candidate_table_layout.py
"$PYTHON_BIN" test_trip_side_panel_contract.py
"$PYTHON_BIN" test_trip_route_board_contract.py
"$PYTHON_BIN" test_trip_leg_rows_contract.py
"$PYTHON_BIN" test_trip_bar_reach_contract.py
"$PYTHON_BIN" test_trip_interaction_closure_contract.py
"$PYTHON_BIN" test_trip_save_boundaries_contract.py
"$PYTHON_BIN" test_trip_zone_updates_contract.py
"$PYTHON_BIN" test_trip_member_departure_window.py
"$PYTHON_BIN" test_panel_states_frontend_contract.py
"$PYTHON_BIN" test_current_guide_contract.py
...
"$PYTHON_BIN" test_inquiry_panel_side_actions.py
"$PYTHON_BIN" test_panel_action_lifecycle.py
"$PYTHON_BIN" test_currency_neutral_priority.py
...
"$PYTHON_BIN" test_followup_workbench_frontend_contract.py
"$PYTHON_BIN" test_trip_briefing_zone_contract.py
"$PYTHON_BIN" test_worklist_workbench_contract.py
"$PYTHON_BIN" test_worklist_context_contract.py
"$PYTHON_BIN" test_dashboard_metrics_contract.py
"$PYTHON_BIN" test_device_identity.py
